class EnvironmentSettings:
    def __init__(self):
        self.workspace_dir = '/home/deshui/pro/OSTrack'    # Base directory for saving network checkpoints.
        self.tensorboard_dir = '/home/deshui/pro/OSTrack/tensorboard'    # Directory for tensorboard files.
        self.pretrained_networks = '/home/deshui/project/OSTrack_pure/pretrained_models'

...
def local_env_settings():
    ...
    settings.network_path = '/home/deshui/pro/OSTrack/output/test/networks'    # Where tracking networks are stored.
    settings.nfs_path = '/home/data/nfs'
    settings.otb_path = '/home/data/otb'
    settings.prj_dir = '/home/deshui/pro/OSTrack'
    settings.result_plot_path = '/home/deshui/pro/OSTrack/output/test/result_plots'
    settings.results_path = '/home/deshui/pro/OSTrack/output/test/tracking_results'    # Where to store tracking results
    settings.save_dir = '/home/deshui/pro/OSTrack/output'
    settings.segmentation_path = '/home/deshui/pro/OSTrack/output/test/segmentation_results'
